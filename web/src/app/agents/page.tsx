...
import { toPrivacySafeAgentError } from "@/lib/agent-view-errors";
...
export default async function AgentsPage() {
  try {
    ...
    // Privacy-safe: never pass raw DB / driver messages that may include secrets.
    console.error("[agents-page] load failed");
    return (
      <AgentsClient
        agents={[]}
        loadError={toPrivacySafeAgentError(
          err,
          "Agent directory is temporarily unavailable. Please try again shortly.",
        )}
      />
    );
  }
